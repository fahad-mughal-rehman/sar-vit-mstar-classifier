...
_Images below are generated by the notebook and saved to `outputs/` — copy them into `results/`
with these exact filenames (or edit the paths here to match whatever you name them) and they'll
render automatically on this page._
